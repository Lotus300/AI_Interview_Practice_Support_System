...
test("面接一覧は所有者・論理削除・作成日時を反映する", async () => {
  const store = new MemoryDataStore();
  await store.saveSession({ id: "old", userId: "usr_1", createdAt: "2026-01-01T00:00:00.000Z", deletedAt: null });
  await store.saveSession({ id: "new", userId: "usr_1", createdAt: "2026-02-01T00:00:00.000Z", deletedAt: null });
  await store.saveSession({ id: "deleted", userId: "usr_1", createdAt: "2026-03-01T00:00:00.000Z", deletedAt: "2026-03-02T00:00:00.000Z" });
  await store.saveSession({ id: "other", userId: "usr_2", createdAt: "2026-04-01T00:00:00.000Z", deletedAt: null });
